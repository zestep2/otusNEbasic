...
т.к. на маршрутизаторе в CPT HTTPS сервер не включается, добавим отдельный https сервер подключенный к коммутатору S1 
...
Политика2 - запртим сети Sales все http\https в Management, на R1, кроме Loopback1
